...
BuildRoot:      %{_tmppath}/%{rname}-%{version}-%{release}-root-%(%{__id_u} -n)
# So far there is no need to have both installed at the same time
Conflicts:      luajit = 2.0.3
Conflicts:      luajit = 2.0.4

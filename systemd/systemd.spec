...
Version:        231
Release:        13.1%{?gitcommit:.git%{gitcommitshort}}%{?dist}
...
Patch2000:      0001-bz-1413099-fix-systemd-in-docker.patch
...
%changelog
* Wed Jan 25 2017 Markus Linnala <Markus.Linnala@cybercom.com> - 231-13.1:.git%{gitcommitshort}}%{?dist}
- Implement fix for tty bug from bz#1413099
